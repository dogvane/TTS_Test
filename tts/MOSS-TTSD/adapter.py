"""MOSS-TTSD 适配器 — 通过 HTTP 调用 MOSS-TTSD 的 OpenAI 兼容 webapi。"""
...
class MOSSTTSDAdapter(BaseAdapter):
    name = "MOSS-TTSD"
    sample_rate = 24000

    # MOSS-TTSD + VoiceGenerator 支持的能力
    ...
    def __init__(self, config_path: str | None = None):
        ...
        logger.info("MOSS-TTSD adapter -> %s", self.base_url)
